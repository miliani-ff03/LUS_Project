...
combinations = list(product(CROP_SETTINGS, BETAS))
total_runs = len(combinations)


print(f"Starting Offline Sweep for {total_runs} runs...")

for i, (crop, beta) in enumerate(combinations):
    
    print(f"\n--- Run {i+1}/{total_runs} ---")
    print(f"Setting: Crop Top={crop*100}%, Beta={beta}")
