...
vae.load_state_dict(torch.load("Best_VAE_ld32_crop10_beta2.0_cyclical.pth", map_location=DEVICE))
vae.eval()
...
fig, axes = plt.subplots(len(top_k_indices), grid_size, figsize=(30, 16))
